...
<div id="fh5co-title-box" style="background-image: url(/images/camila-cordeiro-114636.jpg); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
    ...
    <div class="page-title">
        <?= Html::img('@web/images/person_1.jpg'); ?>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <?= Html::img('@web/images/download (1).jpg', ['class' => 'fh5co_most_trading', 'alt' => '']); ?>
                    </div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <?= Html::img('@web/images/allef-vinicius-108153.jpg', ['class' => 'fh5co_most_trading', 'alt' => '']); ?>
                    </div>
                    <div class="col-7 paddding">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <?= Html::img('@web/images/download (2).jpg', ['class' => 'fh5co_most_trading', 'alt' => '']); ?>
                    </div>
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.</div>
                        <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <?= Html::img('@web/images/seth-doyle-133175.jpg', ['class' => 'fh5co_most_trading', 'alt' => '']); ?>
                    </div>
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.</div>
                        <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
    ...
    <div class="container animate-box">
        ...
        <div class="owl-carousel owl-theme" id="slider2">
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img">
                        <?= Html::img('@web/images/39-324x235.jpg', ['class' => '', 'alt' => '']); ?>
                    </div>
                    <div>
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img">
                        <?= Html::img('@web/images/joe-gardner-75333.jpg', ['class' => '', 'alt' => '']); ?>
                    </div>
                    <div>
                        <a href="#" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img">
                        <?= Html::img('@web/images/ryan-moreno-98837.jpg', ['class' => '', 'alt' => '']); ?>
                    </div>
                    <div>
                        <a href="#" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img">
                        <?= Html::img('@web/images/seth-doyle-133175.jpg', ['class' => '', 'alt' => '']); ?>
                    </div>
                    <div>
                        <a href="#" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
